...
urlpatterns = [
     ...
     path('category/<uuid:uuid>/', views.CategoryRetrieveUpdateRemoveView.as_view(), name='category.retrieve.update.remove'),
     ...
     path('ingredient/<uuid:uuid>/', views.IngredientRetrieveUpdateRemoveView.as_view(), name='ingredient.retrieve.update.remove'),
     ...
     path('manufacturer/<uuid:uuid>/', views.ManufacturerRetrieveUpdateRemoveView.as_view(), name='manufacturer.retrieve.update.remove'),
     ...
     path('supplier/<uuid:uuid>/', views.SupplierRetrieveUpdateRemoveView.as_view(), name='supplier.retrieve.update.remove'),
     ...
     # product
     path('productbase/create/', views.BaseProductCreateView.as_view(), name='product.base.create'),
     path('baseproduct/<int:product_id>/', views.BaseProductRetrieveDeleteView.as_view(),
          name='product.base.retrieve.delete'),
     path('baseproduct/<int:product_id>/', views.BaseProductRemove.as_view(),
          name='product.base.remove'),
     path('baseproduct/<int:product_id>/update/', views.BaseProductUpdateView.as_view(),
          name='product.base.update'),

     # path('baseproduct/<int:product_id>/', views.BaseProductUpdateView.as_view(), name='product.base.update'),
     # path('product/<int:product_id>/base/update/', views.BaseProductUpdateView.as_view(), name='product.base.update'),
